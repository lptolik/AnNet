...
calcAllClustering allows to calculate memberships for all clustering algorithms simultaneously (may take time), and store them on the graph vertices.
In this case, calcMembership command will return the community membership for specific algorithm.
