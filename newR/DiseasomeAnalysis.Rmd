...
```
{r  copm.diseasome.powerlaw,fig.height=6,fig.width=6,error=TRUE}
...
```
{r degree.hdn.powerlaw, fig.height=6,fig.width=6,error=TRUE}
options("show.error.messages"=TRUE)
pFit <- FitDegree( as.vector(igraph::degree(graph=hdn)),plot=TRUE,WIDTH=2480, HEIGHT=2480)
```

```
{r copm.hdn.powerlaw, fig.height=6,fig.width=6,error=TRUE}
options("show.error.messages"=TRUE)
pFit <- FitDegree( as.vector(csz.df$csize[csz.df$src!='rewiring']),
                   plot=TRUE,WIDTH=2480, HEIGHT=2480)
```
...
## Component size fit to power law
```
{r degree.dgn.powerlaw, fig.height=6,fig.width=6,error=TRUE}
pFit <- FitDegree( as.vector(igraph::degree(graph=dgn)),plot=TRUE,WIDTH=2480, HEIGHT=2480)
```
```
{r copm.dgn.powerlaw, fig.height=6,fig.width=6,error=TRUE}
options("show.error.messages"=TRUE)
pFit <- FitDegree( as.vector(csz.df$csize[csz.df$src!='rewiring']),
                   plot=TRUE,WIDTH=2480, HEIGHT=2480)
```
